...
<section data-background-image="assets/imgs/5thElement2.jpg" data-state=fth>
    <style>.fth header:after { content: "Luc Besson, 1977 — The Fifth Element"; }</style>
    <h1 class="NT" style="font-family:'Picnic' !important;text-transform: capitalize !important;line-height: 1;font-size: 5rem !important;" >A Design Brief To Explore The Greater Evil</h1>
</section>

<section data-background-image="assets/imgs/5thElement2.jpg" data-state=fth>
    <h1 class="NT" style="font-family:'Picnic' !important;text-transform: capitalize !important;line-height: 1;font-size: 5rem !important;" >A Foray Into Critical Design Practices</h1>
</section>
...
<section data-state=h1 >
    <h1 class="NT" style="font-family:'UnifrakturCook' !important;text-transform: capitalize !important;line-height: 1;font-size: 5rem !important;" ><span style="text-transform: none;">ll.</span> Widened Streets,<br/>Narrowed Freedoms<br/><span style="font-family:'picnic'; font-size:3rem;">Haussmann's Paris</span></h1>
</section>

<section data-background-image="assets/imgs/haussmann_1.jpg" data-state=h1>
</section>

<section data-background-image="assets/imgs/haussmann_2.webp" data-state=hauss1>
 <style>.hauss1 header:after { content: "J. S. Evrard, 2017 — Arc de Triomphe during the annual Bastille Day military parade"; }</style>
</section>

<section data-state=h1 >
    <h1 class="NT" style="font-family:'UnifrakturCook' !important;text-transform: capitalize !important;line-height: 1;font-size: 5rem !important;" ><span style="text-transform: none;">lll.</span> Data As Weapon<br/><span style="font-family:'picnic'; font-size:3rem;">Cambridgian Analysis</span></h1>
</section>

<section data-background-image="assets/imgs/cambridge_11.png" data-state=cam1>
 <style>.cam1 header:after { content: "Bridge Of Sighs, 1831 — Cambridge"; }</style>
</section>

<section data-background-image="assets/imgs/kogan.webp" data-state=cam2>
 <style>.cam2 header:after { content: "Aleksandr Kogan, 2018 — Cambridge Analytica"; }</style>
</section>

<section data-state=h1>
    <h1 class="NT" style="font-family:'UnifrakturCook' !important;text-transform: capitalize !important;line-height: 1;font-size: 5rem !important;" ><span style="text-transform: none;">lV.</span> APAS<br/><span style="font-family:'picnic'; font-size:3rem;">Androgynous Airlock Politics</span></h1>
</section>
...
<section data-background-color="blueviolet" data-state=h1>
    <span class="quotes">
    <p>✓ <span style="font-family: UnifrakturCook;">Embrace Absurdity:</span> The more over-the-top the ideas, the easier it is to spot ethical and environmental red flags.</p>
    <p class="fragment fade-up">✓ <span style="font-family: UnifrakturCook;">Keep it Fast & Fun:</span> A one-day sprint works best with a spirited, “fail fast” approach.</p>
    <p class="fragment fade-up">✓ <span style="font-family: UnifrakturCook;">Encourage Reflection:</span> Continuously prompt teams to notice how “evil” design reveals hidden biases or oversights that could happen in “good” design.</p>
    </span>
</section>